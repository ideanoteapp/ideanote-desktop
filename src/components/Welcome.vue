      ...
      <div class="flex flex-col justify-center">
        ...
        >
          ...
          <div class="text-center" v-if="slide == 1">
            ...
            <p>
              まだこのアプリは不完全なので、機能が不足していたり、<br />まだすべての機能が実装されていません。<br />欲しい機能があったり、バグを見つけたら<br />「意見を送る」ボタンからそれを送っていただくとありがたいです。
            </p>
            <div>
              <button
                class="py-2 px-3 rounded-lg bg-[#3250b9] w-64 mt-4"
          ...
          <div class="text-center" v-if="slide == 2">
            ...
            <div class="text-2xl font-bold">ベータ版について</div>
            <p>
              また、アプリを使用した感想をSNSにハッシュタグ #ideaNoteベータ
              を添えて<br />投稿してくれるとありがたいです。
            </p>
            <div>
              <button
                class="py-2 px-3 rounded-lg bg-[#3250b9] w-64 mt-4"
