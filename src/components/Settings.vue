<template>
  <div>
    <div class="flex max-h-screen h-screen">
      ...
      <div
        id="sidebar1"
        class="bg-[#262626] w-[180px] lg:w-[200px] h-screen select-none"
      >
        <div
        ...
        <div
          class="px-2 mx-2 text-white flex mt-3 bg-[#353535] py-2 rounded-lg"
        >
          <img
            src="../assets/folder.png"
            alt=""
            class="w-[29px] h-[29px] mr-2 bg-white rounded-full"
          />
          <div class="flex flex-col justify-center mb-1">Moon</div>
        </div>
      ...
      >
        ...
        <div class="">
          ...
          >
            ...
            />
            <div>
              <div class="text-[1.035rem]">ノートの名前</div>
              <div class="opacity-80 text-sm overflow-hidden h-[2.5rem]">
                これはテストテキストです。これはテストテキストです。これはテストテキストです。これはテストテキストです。これはテストテキストです。
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="sidebar2" class="bg-[#1f1f1f] flex-grow h-screen max-h-screen">
        <div class="bg-[#242424] duration-200 h-[54px] text-white flex px-4">
          <div class="flex flex-col justify-center">
            <img
              src="../assets/vue.svg"
              alt=""
