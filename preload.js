...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  createFolder: (name, notebook) => ipcRenderer.invoke('createfolder', [name, notebook]),
  ...
  setupCurrentNotebook: (notebook) => ipcRenderer.invoke('setupcurrentnotebook', notebook),
  setIcon: (notebook) => ipcRenderer.invoke("seticon", notebook),
  deleteNotebook: (notebook) => ipcRenderer.invoke("deletenotebook", notebook),
  changeNoteTitle: (old, newer) => ipcRenderer.invoke('changenotetitle', [old, newer])
})